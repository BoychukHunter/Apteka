...
class MedicinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medicine" do
    assert_difference("Medicine.count") do
      post medicines_url, params: { medicine: { descripition: @medicine.descripition, name: @medicine.name, price: @medicine.price } }
    end
  ...
  test "should update medicine" do
    patch medicine_url(@medicine), params: { medicine: { descripition: @medicine.descripition, name: @medicine.name, price: @medicine.price } }
